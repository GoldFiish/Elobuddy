namespace NebulaSoraka.ControllN
{
    class Kor : Controller
    {
        public Kor()
        {
            Dictionary.Add(EnumContext.Main,            "- 콤보 / 견제");
            Dictionary.Add(EnumContext.Clear,           "- 라인 / 정글");
            Dictionary.Add(EnumContext.Item,            "- 아이템");
            Dictionary.Add(EnumContext.Auto,            "- 자동 스킬");
            ...
            Dictionary.Add(EnumContext.LaneQHit,        "미니언 킬 개수 [ ");
            Dictionary.Add(EnumContext.JungleClear,     "정글");
            Dictionary.Add(EnumContext.JungleHitNum1,   "몬스터 개수가 ");
            Dictionary.Add(EnumContext.JungleHitNum2,   " 이상일 때");
            ...
            Dictionary.Add(EnumContext.sMikael,         "미카엘의 도가니 사용");
            Dictionary.Add(EnumContext.sMikaelOp,       "미카엘 타켓");
            Dictionary.Add(EnumContext.sMikaelOp1,      "아군");
            Dictionary.Add(EnumContext.sMikaelOp2,      "사용자");
            ...
            Dictionary.Add(EnumContext.sAlways,         "항상 작동");
            Dictionary.Add(EnumContext.sSolari,         "강철의 솔라리 펜던트 사용");
            ...
            Dictionary.Add(EnumContext.AutoWOp1,        "낮은 체력");
            Dictionary.Add(EnumContext.AutoWOp2,        "높은 AD");
            Dictionary.Add(EnumContext.AutoWOp3,        "높은 AP");         
            ...
            Dictionary.Add(EnumContext.SpellE,          "E 사용");
            ...
            Dictionary.Add(EnumContext.TeamHp1,         "아군 체력이 ");
            Dictionary.Add(EnumContext.TeamHp2,         " 이하일 때");
        }
    }
}
