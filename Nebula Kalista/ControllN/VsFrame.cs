    ...
    public class VsFrame : ValueBase<Color>
    {
        ...
        public VsFrame(string uId, Color defaultValue) : base(uId, "", 265)
        {
            ImageSprite = new Sprite(
                Texture.FromMemory(
                    Drawing.Direct3DDevice, (byte[])new ImageConverter().ConvertTo(Properties.Resources.Img_Kalista, typeof(byte[])),
                    189, 243, 0, Usage.None, Format.A1, Pool.Managed, Filter.Default, Filter.Dither, 10));
        }
