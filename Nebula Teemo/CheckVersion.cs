    ...
    class CheckVersion : Teemo
    {
        ...
        public static void CheckUpdate()
        {
            ...
            using (var Version_Response = (HttpWebResponse)Request_GitHubVer.GetResponse())
            {
                ...
                {
                    Chat.Print("<font color = '#ffffff'>[ Notice ] </font><font color = '#ebfd00'>Nebula Teemo has been Update </font><font color = '#ffffff'>" + NoticeList[1] + "</font>");

                    MenuNVer = Menu.AddSubMenu(NoticeList[0], "SubMenu9");
