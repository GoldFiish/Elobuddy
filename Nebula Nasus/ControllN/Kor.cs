namespace NebulaNasus.ControllN
{
    class Kor : Controller
    {
        public Kor()
        {
            ...
            Dictionary.Add(EnumContext.sQSS,            "수은 장식띠 사용");
            Dictionary.Add(EnumContext.sScimiter,       "헤르메스의 시미터 사용");
            Dictionary.Add(EnumContext.sDelay,          " 후에 캐스팅");
            Dictionary.Add(EnumContext.sBlind,          "실명");
            Dictionary.Add(EnumContext.sCharm,          "매혹");
            Dictionary.Add(EnumContext.sFear,           "공포");
            Dictionary.Add(EnumContext.sPloymorph,      "변형");
