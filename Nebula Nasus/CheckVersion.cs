    ...
    class CheckVersion : Nasus
    {
        ...
        public static void CheckUpdate()
        {
            ...
            using (var Version_Response = (HttpWebResponse)Request_GitHubVer.GetResponse())
            {
                ...
                {
                    Chat.Print("<font color = '#ffffff'>[ Notice ] </font><font color = '#ebfd00'>Nebula Nasus has been Update </font><font color = '#ffffff'>" + NoticeList[1] + "</font>");
